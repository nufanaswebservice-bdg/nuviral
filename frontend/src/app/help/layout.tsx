...
export const metadata: Metadata = {
  title: 'Help Center - NuNuViral Video Generator | Panduan & FAQ',
  ...
  openGraph: {
    title: 'Help Center - NuNuViral Video Generator',
    description: 'Panduan lengkap menggunakan NuNuViral untuk membuat video viral secara otomatis. FAQ, tutorial, dan tips.',
  ...
  twitter: {
    ...
    title: 'Help Center - NuNuViral Video Generator',
    description: 'Panduan lengkap menggunakan NuNuViral untuk membuat video viral secara otomatis.',
  },
  alternates: {
