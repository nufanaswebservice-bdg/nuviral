    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">AI model settings, API keys, dan generation logs</p>
        </div>
        <button onClick={fetchConfig} className="p-2 rounded-lg hover:bg-white/5 transition">
        ...
        <>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-5 rounded-xl bg-gray-900 border border-white/5">
              ...
              <p className="text-lg font-bold text-violet-400 mt-1">{config.primaryModel}</p>
              <p className="text-xs text-gray-500 mt-1">~{config.primaryCost} per video</p>
            </div>
            <div className="p-5 rounded-xl bg-gray-900 border border-white/5">
              <p className="text-sm font-medium text-gray-300">Fallback Models</p>
              <p className="text-lg font-bold text-amber-400 mt-1">{config.fallbackModels?.join(', ')}</p>
            ...
            <div className="p-5 rounded-xl bg-gray-900 border border-white/5">
              ...
              <p className="text-lg font-bold text-emerald-400 mt-1">{config.ttsModel}</p>
              <p className="text-xs text-gray-500 mt-1">Bahasa Indonesia support</p>
            </div>
            <div className="p-5 rounded-xl bg-gray-900 border border-white/5">
              <p className="text-sm font-medium text-gray-300">Prompt Optimizer</p>
              <p className="text-lg font-bold text-blue-400 mt-1">{config.promptModel}</p>
          ...
          {/* Plan Limits */}
          <div className="p-5 rounded-xl bg-gray-900 border border-white/5">
            <h3 className="font-medium mb-4">Plan Limits (50% Profit Margin)</h3>
            <div className="grid grid-cols-3 gap-4">
              {config.plans?.map((plan: any) => (
                <div key={plan.name} className="p-4 rounded-lg bg-white/5">
